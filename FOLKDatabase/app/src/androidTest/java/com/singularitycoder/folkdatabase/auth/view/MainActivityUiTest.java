...
public class MainActivityUiTest {
    ...
    private static final String APP_PACKAGE_NAME = "com.singularitycoder.folkdatabase";
...
//        idlingResource = activityTestRule.getActivity().getWaitingState();
        ...
        authViewModel = new ViewModelProvider(activityTestRule.getActivity()).get(AuthViewModel.class);
